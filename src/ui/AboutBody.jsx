  ...
  return (
    <div className="my-5 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row gap-7 mt-10">
        <div className="tab w-[100%] md:w-[60%] h-[400px] bg-[url('images/bg-img.jpg')] bg-no-repeat bg-center bg-cover bg-blend-overlay bg-[rgba(10,10,10,0.65)] flex flex-col lg:flex-row gap-5 items-center lg:justify-between px-[5%] lg:py-32  ">
